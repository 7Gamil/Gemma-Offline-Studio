...
- For downloading files, you can either use the web browser simulation toolkit or write codes.
    ...
    def step(
        ...
        # 1. USER anget gets assistant_response
        ...
        # 2. ASSISTANT agent gets user_response
        # Add auxiliary information to the user's message
...
"""
        ...
        # 3. USER agent gets assistant_response
...
def run_society(
    ...
    for _round in range(round_limit):
        ...
        print("User Response")
        print(repr(user_response.msg.content))

        print("User Response==================================================")

        print("assistant Response")
        print(repr(assistant_response))
        print("Raw assistant response info:")
        print(assistant_response.info)
